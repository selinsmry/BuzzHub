...
function Sidebar() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-gradient-to-br from-orange-900/20 to-pink-900/10 border border-orange-700/30 rounded-2xl overflow-hidden shadow-xl">
        <div className="p-4 bg-gradient-to-r from-orange-500/20 to-pink-500/20 border-b border-orange-700/30">
          <h3 className="font-bold text-sm text-orange-300">✨ Kişiselleştirme</h3>
        </div>
        
        <div className="p-3 space-y-2">
          <button 
            onClick={() => navigate('/recommendations')}
            className="w-full p-3 text-left text-sm font-semibold text-orange-300 hover:bg-orange-500/20 rounded-lg transition flex items-center gap-2"
          >
